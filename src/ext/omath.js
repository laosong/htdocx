...
export class OMath extends docx.XmlComponent {
  ...
  init() {
    ...
    const ommlObj = xml2Js.xml2js(this.omml, {compact: false});
    ...
    if (this.fontSize) {
      const fontEle = {
        ...
        name: 'w:rPr',
        elements: [
          {type: 'element', name: 'w:sz', attributes: {'w:val': this.fontSize}},
          {type: 'element', name: 'w:szCs', attributes: {'w:val': this.fontSize}}
        ]
      };
